...
NOTE: For *all* CLI options, flags, and target-specific setup see link:./docs/INSTALL.md[*INSTALL.md*].

== 📖 Documentation and Principles

* The single source of truth for all rules is link:./principles.md[`principles.md`].
* For the full categorized rules reference see link:./docs/ACKNOWLEDGMENTS.md[*ACKNOWLEDGMENTS].
