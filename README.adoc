...
* For the full categorized rules reference see link:./DOCS.md[*DOCS.md*].
...
Contributions and feature suggestions are welcome. Feel free to check the link:https://github.com/r37r0m0d3l/hardwired_skill_typescript/issues[issues page] if you want to propose a new rule.
